...
def el(name: str, children: list[str], classes: list[str] | str | None = None, style: dict[str, str] | None = None, attributes: dict[str, Any] | None = None) -> str:
    tag_contents = [
        name,
        classes_to_string(classes) if classes is not None else None,
        style_to_string(style) if style is not None else None,
